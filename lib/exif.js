 ...
 */
 ...
 //const playstore = 'https://play.google.com/storaqe/apps/details?id=com.stickify.stickermaker'
 const itunes = 'https://itunes.apple.com/app/sticker-maker-studio/id1443326857'
 const playstore = "https://instagram.com/isywl_"
 /**
  * @class Exif
  */
 class Exif {
 ...
 new Exif().create('aex-bot', '@isywl_', 'default')
